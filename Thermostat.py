...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        # Update the heat indicator based on the current temperature.
        self.updateLights()
    ...
    def on_exit_heat(self):
        # Turn off the heat indicator when leaving heat mode.
        redLight.off()
    ...
    def on_enter_cool(self):
        # Update the cool indicator based on the current temperature.
        self.updateLights()
    ...
    def on_exit_cool(self):
        # Turn off the cool indicator when leaving cool mode.
        blueLight.off()
    ...
    def processTempStateButton(self):
        ...
        # Trigger the state machine event to move to the next thermostat state.
        self.cycle()
    ...
    def processTempIncButton(self):
        ...
        # Increase the set point and refresh the LED indicators.
        self.setPoint += 1
        self.updateLights()
    ...
    def processTempDecButton(self):
        ...
        # Decrease the set point and refresh the LED indicators.
        self.setPoint -= 1
        self.updateLights()
    ...
    def updateLights(self):
        ...
        # Update the LEDs based on the current thermostat state and temperature.
    ...
    def setupSerialOutput(self):
        # Build a comma-delimited status string for the thermostat server.
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            # Display the current date and time on the first LCD line.
            lcd_line_1 = current_time.strftime("%m/%d %H:%M:%S") + "\n"
    
            ## Setup Display Line 2
            if(altCounter < 6):
                # Display the current temperature on the second LCD line.
                lcd_line_2 = f"Temp: {self.getFahrenheit():.1f} F"
    
                altCounter = altCounter + 1
            else:
                # Display the thermostat state and set point on the second LCD line.
            ...
            if((counter % 30) == 0):
                # Send the current thermostat status to the server simulator.
...
# Assign the green button to cycle between off, heat, and cool states.
...
##
redButton = Button(25)
# Assign the red button to increase the thermostat set point.
...
# Assign the blue button to decrease the thermostat set point.
